...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex">
                    <button class="btn btn-light w-100 bi bi-box-arrow-in-right me-3" type="button" data-bs-toggle="modal" data-bs-target="#formLoginModal">
                        Login
                    </button>

                    <!-- Modal -->
                    <div class="modal modal fade" id="formLoginModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="formLoginModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="formLoginModal">เข้าสู่ระบบ</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <label for="first" class="form-label "> ชื่อจริง</label>
                                    <input type="text" class="form-control mb-3" name="first" required autofocus>
    ...
    <div class="container">
        <div class="row">
            <?php include("./user1/components/card.php"); ?>
            <?php include("./user1/components/card.php"); ?>
            <?php include("./user1/components/card.php"); ?>
            <?php include("./user1/components/card.php"); ?>
        </div>
    ...
    <div class="container">
        <div class="row">
            <?php include("./user1/components/flip-card.php"); ?>
            <?php include("./user1/components/flip-card.php"); ?>
            <?php include("./user1/components/flip-card.php"); ?>
            <?php include("./user1/components/flip-card.php"); ?>
        </div>
